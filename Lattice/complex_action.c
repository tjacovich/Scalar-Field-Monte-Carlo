...
void deltaction(double* phiR, double* phiI, double tempR, double tempI, double a,  double* dS_nR, double* dS_nI, double* dS_oR, double* dS_oI, int dim_lat, int cnt, double lambda, double h)
  {
    ...
    *dS_nR = a*(tempR*tempR+tempI*tempI)/2+tempR*neiR+tempI*neiI+(lambda/4)*(tempR*tempR+tempI*tempI)*(tempR*tempR+tempI*tempI)+h*tempR;
    *dS_nI = tempR*neiI-tempI*neiR;

    tempR = phiR[cnt];
    tempI = phiI[cnt];

    *dS_oR = a*(tempR*tempR+tempI*tempI)/2+tempR*neiR+tempI*neiI+(lambda/4)*(tempR*tempR+tempI*tempI)*(tempR*tempR+tempI*tempI)+h*tempR;
    *dS_oI = tempR*neiI-tempI*neiR;
 } 
